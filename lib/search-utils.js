...
function searchFromRouteAndPlace(r, p) {
    ...
    return {
        ...
        sort        : _.isString(r.query.sort) ? [r.query.sort] : r.query.sort,
...
function isSearchEmpty(search) {
    return _.isUndefined(search.q) && _.isUndefined(search.days) && _.isUndefined(search.priceLevel) && _.isUndefined(search.selections) && _.isUndefined(search.categories) && _.isUndefined(search.tags) && _.isUndefined(search.withDiscount) && _.isUndefined(search.selections);
}
...
function hairfieSearchToTitle(search, place, url) {
    ...
    if(place.title && place.title.tags && place.title.tags.default && isSearchEmpty(search)) {
...
function searchToDescription (search, place, url) {
    ...
    } else if(isSearchEmpty(search) && place && place.description && place.description.default) {
