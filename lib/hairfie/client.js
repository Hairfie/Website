...
Client.prototype.search = function (queryParams, config) {
        console.log("clientTypes in client.js", queryParams);

    console.log("clientTypes in client.js", _.toQuery(queryParams));

    var req = request
        .get(this._buildUrl('businesses/search'))
        .query(_.toQuery(queryParams));
