    ...
    render: function () {
        return (
            <section className="home-section deals">
                ...
                <p className="subtitle">Dealées rien que pour vous : des promotions pour donner le sourire à vos cheveux. Cadeau bonus : les offres sont valables dans tout le salon de coiffure (produits compris) ! Elle est pas belle la vie ?</p>
