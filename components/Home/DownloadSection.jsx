            ...
            <section className="home-section download">
                <div className="container">
                    <div className="col-sm-6">
                        ...
                        <p>Pour avoir toujours Hairfie au bout des doigts et pouvoir poster vos plus beaux #Hairfies, téléchargez notre application iOS pour le moment (Android bientôt)</p>
                        <p>
