        ...
        return (
            <ParentLayout>
                <div className={"salon " + (business.accountType && business.accountType.toLowerCase())} id="content">
                    ...
                    <Carousel id="carousel-salon" className={!business.pictures ? "" : "noPicture"} backgroundStyle={true} gallery={true} backgroundProps="linear-gradient(transparent, rgba(0,0,0,0.4)),"  pictures={business.pictures} alt={business.name + ' | Hairfie'}/>
