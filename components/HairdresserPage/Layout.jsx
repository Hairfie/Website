...
var HairdresserLayout = React.createClass({
    ...
    render: function() {
        ...
        var background = this.props.hairdresser.picture ? <Picture className="short-background hairdresser" picture={this.props.hairdresser.picture} options={{effect: "blur:1000", height: 470, crop: "crop"}} placeholder="/img/placeholder-640.png" backgroundStyle={true}></Picture> : "";
        return (
            <PublicLayout>
            {background}
